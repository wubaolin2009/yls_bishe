...
class OnlineLDA:
    ...
    def __init__(self, vocab, K, D, alpha, eta, tau0, kappa, gamma_iteration_times):
        """
        Arguments:
        K: Number of topics
        ...
        self._kappa = kappa
        self._updatect = 0
        self.gamma_iteration_times = gamma_iteration_times
    ...
    def do_e_step(self, docs):
        ...
        for d in range(0, batchD):
            ...
            for it in range(0, self.gamma_iteration_times):
                lastgamma = gammad
