...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Goods'
        db.create_table(u'yls_app_goods', (
            ('product_html', self.gf('django.db.models.fields.CharField')(max_length=50, primary_key=True)),
        ...
        db.send_create_signal(u'yls_app', ['Goods'])


    def backwards(self, orm):
        # Deleting model 'Goods'
        db.delete_table(u'yls_app_goods')
