...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TweetToken'
        db.create_table(u'yls_app_tweettoken', (
            ('tweet', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True)),
            ('tokens', self.gf('django.db.models.fields.CharField')(max_length=1500)),
        ))
        db.send_create_signal(u'yls_app', ['TweetToken'])

        # Adding model 'StopWords'
        db.create_table(u'yls_app_stopwords', (
            ('word', self.gf('django.db.models.fields.CharField')(max_length=30, primary_key=True)),
        ))
        db.send_create_signal(u'yls_app', ['StopWords'])


    def backwards(self, orm):
        # Deleting model 'TweetToken'
        db.delete_table(u'yls_app_tweettoken')

        # Deleting model 'StopWords'
        db.delete_table(u'yls_app_stopwords')
