...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GoodsProcessed'
        db.create_table(u'yls_app_goodsprocessed', (
            ('product_html', self.gf('django.db.models.fields.CharField')(max_length=50, primary_key=True, db_index=True)),
        ...
        db.send_create_signal(u'yls_app', ['GoodsProcessed'])


    def backwards(self, orm):
        # Deleting model 'GoodsProcessed'
        db.delete_table(u'yls_app_goodsprocessed')
