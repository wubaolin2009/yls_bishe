...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GoodsProcessed.product_des'
        db.alter_column(u'yls_app_goodsprocessed', 'product_des', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'GoodsProcessed.product_des'
        db.alter_column(u'yls_app_goodsprocessed', 'product_des', self.gf('django.db.models.fields.CharField')(max_length=1800))
