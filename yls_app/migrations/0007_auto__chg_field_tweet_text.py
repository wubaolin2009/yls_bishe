...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'yls_app_tweet', 'text', self.gf('django.db.models.fields.CharField')(max_length=700))

    def backwards(self, orm):

        # Changing field 'Tweet.text'
        db.alter_column(u'yls_app_tweet', 'text', self.gf('django.db.models.fields.CharField')(max_length=300))
