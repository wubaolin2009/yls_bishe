...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'yls_app_tweet', 'tweet_id', self.gf('django.db.models.fields.CharField')(max_length=100, primary_key=True))

    def backwards(self, orm):

        # Changing field 'Tweet.tweet_id'
        db.alter_column(u'yls_app_tweet', 'tweet_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
