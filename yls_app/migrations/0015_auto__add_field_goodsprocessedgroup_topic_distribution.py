...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GoodsProcessedGroup.topic_distribution'
        db.add_column(u'yls_app_goodsprocessedgroup', 'topic_distribution',
                      self.gf('django.db.models.fields.TextField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GoodsProcessedGroup.topic_distribution'
        db.delete_column(u'yls_app_goodsprocessedgroup', 'topic_distribution')
    ...
    models = {
        ...
        u'yls_app.goodsprocessed': {
            ...
            'product_category': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'product_des': ('django.db.models.fields.TextField', [], {}),
            'product_html': ('django.db.models.fields.CharField', [], {'max_length': '50', 'primary_key': 'True', 'db_index': 'True'})
        },
        u'yls_app.goodsprocessedgroup': {
            ...
            'topic_distribution': ('django.db.models.fields.TextField', [], {'null': 'True'})
        },
        u'yls_app.stopwords': {
